        ...
        >
          ...
          >
            <Box sx={{ textAlign: "center", mb: 3 }}>
              ...
              >
                Upload an image of your Discus fish and our AI will identify its
                variety. Get instant information about different Discus types
          ...
          >
            ...
            >
              ...
              <Typography variant="body2" color="text.secondary" paragraph>
                Discus fish (Symphysodon) are a genus of cichlids native to the
                Amazon River basin. Known for their disc-shaped bodies and
                vibrant colors, they're often called the "King of the Aquarium"
                due to their striking appearance and peaceful temperament.
              </Typography>
              <Typography variant="body2" color="text.secondary">
                Our classifier can identify various popular Discus varieties
                including Red Checkerboard, Blue Diamond, Pigeon Blood, Snake
                Skin, and Golden Leopard, among others.
              </Typography>
            </Paper>
          </Box>
        </motion.div>
